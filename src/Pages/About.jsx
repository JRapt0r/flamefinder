...
function About() {
  return (
    <div className="grid grid-cols-3">
      ...
      <div className="flex flex-col col-span-3 px-8 py-4 bg-white border border-gray-300 rounded-md shadow sm:m-2 md:my-4 md:ml-4 lg:col-span-2 faq">

        {/* About */}
        <h1 className="mt-4 text-2xl md:text-3xl font-brand">FlameFinder</h1>
        <div className="mt-4 space-y-2 leading-8 md:text-lg">
        ...
        <div className="flex flex-col my-8">
          <h2 className="mb-4 text-lg font-semibold tracking-wide md:text-xl">FAQ</h2>
