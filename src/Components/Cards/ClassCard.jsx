...
function ClassCard({ CRSNBR, CRSTITLE, CRSSUBJCD, SEASON, YEAR, avg_gpa, PrimaryInstructor }) {
  return (
    <Link to={`/class/${CRSSUBJCD}+${CRSNBR}+${PrimaryInstructor}+${SEASON}+${YEAR}`}>
      <div className="flex flex-col min-w-[22rem] md:min-h-[13rem] md:min-w-[25rem] w-auto py-6 my-2 transition-all transform bg-white border border-gray-300 rounded-lg shadow-md cursor-pointer md:m-2 hover:shadow-xl hover:-translate-y-1 ring-black">
